...
class Student11_09 implements Comparable {
	String name;
	int ban;
	int no;
	int kor;
	...
	Student11_09(String name, int ban, int no, int kor, int eng, int math) {
		this.name = name;
		this.ban = ban;
		this.no = no;
		this.kor = kor;
...
class ClassTotalComparator implements Comparator {
	public int compare(Object o1, Object o2) {
		...
		*/
		...
		if(o1 instanceof Student11_09 && o2 instanceof Student11_09) {
			Student11_09 s1 = (Student11_09) o1;
			Student11_09 s2 = (Student11_09) o2;
...
public class q11_09 {
	...
	public static void calculateSchoolRank(List list) {
		...
		public static void main(String[] args) {
			...
			list.add(new Student11_09("이자바",2,1,70,90,70)); 
			list.add(new Student11_09("안자바",2,2,60,100,80)); 
			list.add(new Student11_09("홍길동",1,3,100,100,100)); 
			list.add(new Student11_09("남궁성",1,1,90,70,80)); 
			list.add(new Student11_09("김자바",1,2,80,80,90));
